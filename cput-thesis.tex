...
% --- Start roman page numbering (front matter) ---
\frontmatter
...
% Generated table of contents and lists. Run the compile script after adding,
% removing, or renaming chapters, figures, tables, bibliography, or appendices.
\cputcontents

% --- Main matter (arabic numbers start at 1 on first chapter) ---
\mainmatter

% Chapters
% Each chapter can be in a separate file and included with \include{chapter1}
